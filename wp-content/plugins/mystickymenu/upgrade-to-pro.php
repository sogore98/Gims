...
$features = [
    [
        'title' => esc_html__("Multi Welcome bar", "mystickymenu"),
        'tooltip' => esc_html__("Create a separate welcome bar for different pages based on page targeting rules (E.g. for different languages, different product categories and much more)", "mystickymenu"),
    ],
    [
        'title' => esc_html__("Countdown timer", "mystickymenu"),
        'tooltip' => esc_html__("Add a countdown timer element to your Welcome Bar to increase conversion rate, announce flash sales, and more", "mystickymenu") . '<img src="'.MYSTICKYMENU_URL .'/images/countdown.gif" />'
    ],
	[
        'title' => esc_html__("Sliding Texts", "mystickymenu"),
    ...
    [
        'title' => esc_html__("Show coupons from the top bar", "mystickymenu"),
    ...
    [
        'title' => esc_html__("Show on scroll up/down", "mystickymenu"),
        'tooltip' => esc_html__("You can show the menu when scrolling up, down or both", "mystickymenu")
    ],
    [
        'title' => esc_html__("Devices", "mystickymenu"),
	...
	[
        ...
        'tooltip' => esc_html__("Show or hide your welcome bar for specific countries. Create unique welcome bars for different countries and tailor your messaging to specific audiences", "mystickymenu")
    ],
    [
    ...
    [
        'title' => esc_html__("Welcome bar", "mystickymenu"),
                    ...
                    <div class="pricing-header-top">
                        <div class="plan-row">
                            <div class="plan-col first-col plan-data">
                                <span class="plan-plugin-name">My Sticky Menu</span>
                            ...
                            <ul>
                                <li>
                                    <a href="javascript:;" class="has-tooltip">
                                        ...
                                        <span class="table-tooltip">
                                            <span class="table-tooltip-text">
                                                Use My Sticky Menu on 1 domain
                                            </span>
                                            <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg"> <g opacity="0.5" clip-path="url(#clip0_1771_2646)"> <path d="M8.00016 14.9544C11.6821 14.9544 14.6668 11.9697 14.6668 8.28776C14.6668 4.60586 11.6821 1.62109 8.00016 1.62109C4.31826 1.62109 1.3335 4.60586 1.3335 8.28776C1.3335 11.9697 4.31826 14.9544 8.00016 14.9544Z" stroke="#747C97" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"/> <path d="M8 10.9538V8.28711" stroke="#747C97" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"/> <path d="M8 5.62109H8.00667" stroke="#747C97" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"/> </g> <defs> <clipPath id="clip0_1771_2646"> <rect width="16" height="16" fill="white" transform="translate(0 0.287109)"/> </clipPath> </defs> </svg>
                                        </span>
                                    </a>
...
<div class="premio-faqs">
    <div class="price-container">
        ...
        <div class="faq-lists">
            ...
            $faqs = [
                [
                    'question' => "How long is my paid My Sticky Menu plugin license valid for?",
                    'answer' => "Once you purchase any paid plan of My Sticky Menu, you can use it forever. Support and updates are available for 1 year. You can renew your license each year to get another year of support and updates."
                ],
                [
                    'question' => "Can I use My Sticky Menu plugin on more than 1 domain?",
                    'answer' => "There are 2 ways to do it:
                        <ul>
                        <li>You can install the free My Sticky Menu plugin on any website you want</li>
                ...
                [
                    'question' => "Will My Sticky Menu stop working if I don’t renew my license?",
                    'answer' => "Of course NOT!<br/>My Sticky Menu plugin and all your settings will continue to work as before; however, you will no longer receive plugin updates including feature additions, improvements, and support."
                ],
            ];
